-- query to . create sample table while establishing DB connection- ticket 110
...
--queries created as per ERD diagram -Sprint4- ticket (134)-ticket -135
...
CREATE TABLE edge (
                      ...
                      start_vertex_id INT NOT NULL REFERENCES vertex(vertex_id),
                      end_vertex_id INT NOT NULL REFERENCES vertex(vertex_id),
